...
public class Comanda implements Serializable {
	...
	public Comanda(int iD, int cD_PERSON, int nR_COMANDA, int cD_AREA_EVT, String tP_PERSON, Date dH_ATD,
			int cD_USU_ATD, Boolean tP_SIT, Date dH_ATU, int cD_USU_ATU) {
		ID = iD;
		CD_PERSON = cD_PERSON;
